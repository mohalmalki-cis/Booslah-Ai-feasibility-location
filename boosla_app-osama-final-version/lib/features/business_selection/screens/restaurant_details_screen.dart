...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> {
  ...
  // Toggles — متوافقة مع dataset (True/False)
  bool _is24Hours = false;
  bool _hasInternalSeating = true; // dine_in
  bool _hasCarService = false; // drive_thru
  bool _hasExternalTables = false; // outdoor_table

  // Dropdowns — القيمة المخزنة إنجليزية (تتوافق مع الـ dataset)
  ...
  // restaurant_type — dataset values: Breakfast, Fast Food, Grill, Italian, Traditional
  final Map<String, String> _restaurantTypeOptions = {
    'Breakfast': 'مطعم فطور',
    'Fast Food': 'فاست فود',
    'Grill': 'مشاوي',
    'Italian': 'مطعم إيطالي',
    'Traditional': 'مطعم عربي تقليدي',
  };
  ...
  void _onContinue() {
    ...
    if (_restaurantType == null) {
      _showError('الرجاء اختيار نوع المطعم');
      return;
    }
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildToggleCard(
                        ...
                        onChanged: (v) =>
                            setState(() => _hasInternalSeating = v),
                      ),
                      ...
                      _buildToggleCard(
                        ...
                        onChanged: (v) => setState(() => _hasCarService = v),
                      ),
